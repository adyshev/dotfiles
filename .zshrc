# Enable Powerlevel10k instant prompt. Should stay close to the top of ~/.zshrc. a 
...
plugins=(git fzf macos zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting)
