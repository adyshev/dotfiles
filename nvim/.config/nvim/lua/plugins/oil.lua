        ...
        config = function()
            require("oil").setup({
                ...
                keymaps = {
                    ...
                    ["<C-h>"] = require("smart-splits").move_cursor_left, -- { 'actions.select', opts = { horizontal = true }, desc = 'Open the entry in a horizontal split' },
                    ["<C-l>"] = require("smart-splits").move_cursor_right, -- { 'actions.select', opts = { horizontal = true }, desc = 'Open the entry in a horizontal split' },
